...
def export_and_send_data():
    mdb_file_path = "C:\Pas\Samples\Sampless"  
    ...
    command ='curl -X POST https://app.hittest.smarty.camp/api/v1/DieqiYpQeb3sOvPfDUwi/telemetry -H "Content-Type: application/json" -d "@C:\project campus\code\data\Sample_json'
...
def main():
    ...
    schedule.every(8).hours.do(export_and_send_data)
